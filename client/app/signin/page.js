        ...
        <div className="w-full">
            ...
            <div className="">
              ...
              <p className="text-gray-400 pt-5">
                ...
                <Link href="signup" className="text-purple-400 underline hover:text-purple-300 transition-colors">
                  Log in
                </Link>
              </p>
            </div>
...
{/* Password */}
              ...
              <div className="relative my-4">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-4 bg-gray-800 text-gray-400">Or Sign in with</span>
                </div>
              </div>
