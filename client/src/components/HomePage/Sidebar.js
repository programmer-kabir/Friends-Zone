...
const currentUser = useUser();
  return (
    <>
      <aside className="fixed left-0 top-0 h-full w-1/5 bg-white shadow-xl px-6 flex flex-col justify-between">
        {/* Top Section */}
        ...
        <div className="flex items-center gap-2 hover:bg-[#f0f0f0] px-3 py-2 rounded-md cursor-pointer mb-4 border-t-2">
